...
WebUI.verifyElementPresent(findTestObject('projectCreateNewProjectPage/div_nonFirstTimeNewProjectPopup'), GlobalVariable.timeOutTime)
...
WebUI.verifyElementVisible(findTestObject('projectCreateNewProjectPage/select_existingProject'), FailureHandling.STOP_ON_FAILURE)
