...
WebUI.verifyElementPresent(findTestObject('projectDetailPage/a_sideNav_exisingProjectTasks'), GlobalVariable.timeOutTime)

WebUI.click(findTestObject('projectDetailPage/a_sideNav_exisingProjectTasks'))
